...
import { writeCollection, updateStock } from "../../helpers/DBpost";
import { swalSuccessBuy } from "../../helpers/swalModals";
import { checkName, checkEmail,  checkPhone,  checkCreditCardNumber,  checkSecurityCode, } from "../../helpers/dataCheck";
...
const Payment = () => {
    ...
    const checkData = () => {
        if (checked) payBtn.current.click();
    };
    ...
    return (
        ...
        {cart.length > 0 ? (
            ...
            <div className="flex flex-row flex-wrap justify-center w-full mx-auto min-w-screen min-h-screen px-[15%] sm:p-6 p-12">
                ...
                <div className="mx-auto  flex items-center justify-center w-full max-w-[820px]">
                    <Formik
                    initialValues={{
                        name: "",
                        email: "",
                    ...
                    >
                    {({ errors }) => (
                        <Form className="w-full mx-auto rounded-lg bg-white shadow-lg border border-gray-200 p-5 text-gray-700 ">
                        <div className="w-full pt-1 pb-5">
                            <div className="bg-red-rug-500 text-white overflow-hidden rounded-full w-20 h-20 -mt-16 mx-auto shadow-lg flex justify-center items-center">
                        ...
                        <div className="mb-3">
                            ...
                            <Field
                                ...
                                placeholder="Lucio Jesus Ramirez Gamarra"
                                type="text"
                                id="name"
                                name="name"
                            />
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                            <Field
                                className="w-36 px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-gray-500 transition-colors"
                ...
                <div className="mx-auto w-full flex items-center justify-center max-w-[820px] pt-4 w-full">
                    <div className="w-full mx-auto rounded-lg bg-white shadow-lg border border-gray-200 p-5 text-gray-700 pb-12">
                    <div className="mb-3">
                    ...
                    <div className="flex flex-row flex-wrap align-center justify-between">
                        <div>
                        <label className="font-bold text-sm mb-2 ml-1">
                            Código Postal
                        </label>
                        <div className="mb-4">
                            <input
                            className="w-32 px-3 py-2  border-2 border-gray-200 rounded-md focus:outline-none focus:border-gray-500 transition-colors"
                            placeholder="0000"
                            type="number"
                            disabled
                            />
                        ...
                        <div className="mb-4">
                            <input
                            className="w-32 px-3 py-2 text-center  border-2 border-gray-200 rounded-md focus:outline-none focus:border-gray-500 transition-colors"
                            placeholder="$0"
                            type="text"
                ...
                <div className="flex-1 min-w-[320px] flex items-start  max-w-[820px] p-[4%] md:flex-none md:min-w-[35%]">
                <Formik
                    initialValues={{
                    CCName: "",
                    CCNumber: "",
                    ...
                    onSubmit={(values) => {
                    console.log("Formulario tarjeta enviado");
                    }}
                >
                    {({ errors }) => (
                    <Form>
                        ...
                        <div className="mb-10">
                            <h1 className="text-center font-bold text-xl uppercase">
                            Datos de tarjeta{" "}
                            <span className="text-red-rug-700">{card}</span>
                            </h1>
                        </div>
                        <div className="mb-3 flex flex-wrap -mx-2 justify-center">
                            ...
                            <button
                                ...
                                type="button"
                                className="text-black bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:ring-gray-100 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#2557D6]/50 mr-2 mb-2"
                            >
                                <svg
                                className="w-10 h-3 mr-2 -ml-1"
                                viewBox="0 0 256 64"
                        ...
                        <div className="mb-3 -mx-2 flex items-end">
                            ...
                            <div>
                                ...
                                as="select"
                                name="CCmonth"
                                className="form-select w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-gray-500 transition-colors cursor-pointer"
                                >
                        ...
                        <div>
                            ...
                            type="submit"
                            onClick={checkData}
                            className="block w-full max-w-xs mx-auto bg-red-rug-700 hover:bg-red-rug-500 border-gray-500 hover:border-gray-500 focus:border-gray-500 text-white rounded-lg px-3 py-3 font-semibold"
                            >
                            PAGAR
                            </button>
                        </div>
